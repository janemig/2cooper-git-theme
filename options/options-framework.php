...
define('OPTIONS_FRAMEWORK_URL', get_bloginfo('template_url') .'/options/');
...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		$of_page = add_menu_page('Theme Settings', 'Theme Settings', 'delete_pages', 'options-framework','optionsframework_page');
